...
export const createCustomer = (req: Request, resp: Response) => {
...
export const updateCustomer = (req: Request, resp: Response) => {
...
export const deleteCustomer = (req: Request, resp: Response) => {
...
export const getAllCustomers = (req: Request, resp: Response) => {
...
export const getCustomerById = (req: Request, resp: Response) => {
